...
def print_event_result(
    ...
    forecast = numbers.get(
        "forecast",
        result.get("forecast", "N/A"),
    )

    previous = numbers.get(
        "previous",
        result.get("previous", "N/A"),
    )

    print(
        "Previous NFP:",
        previous,
        "K" if previous not in (None, "N/A") else "",
    )

    print(
        "Actual NFP:",
        actual,
        "K" if actual not in (None, "N/A") else "",
    )

    print(
        "Forecast NFP:",
        forecast,
        "K" if forecast not in (None, "N/A") else "",
    )
...
def main():
    ...
    print(
        "NFP + GOLD TECHNICAL SEQUENCE ENGINE"
    )
