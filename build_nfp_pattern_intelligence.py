...
INPUT_FILE = Path(
    "data/nfp/reactions/gold_reactions.json"
)

OUTPUT_FOLDER = Path(
    "data/nfp/pattern-intelligence"
)

OUTPUT_FILE = (
    OUTPUT_FOLDER / "nfp_gold_patterns.json"
)
...
def extract_conditions(event):
    ...
    # NFP FUNDAMENTAL CLASSIFICATION
    #
...
def main():
    ...
    print(
        "NFP PATTERN INTELLIGENCE ENGINE V1"
    )
    ...
    output = {
        ...
        "engine":
            "EDGE_X_NFP_PATTERN_INTELLIGENCE_V1",
