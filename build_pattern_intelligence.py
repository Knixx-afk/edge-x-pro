...
INPUT_FILE = Path(
    "data/verified-gold-reactions/gold_reactions.json"
)

OUTPUT_FOLDER = Path(
    "data/pattern-intelligence"
)

OUTPUT_FILE = (
    OUTPUT_FOLDER / "fed_gold_patterns.json"
)
...
def main():
    ...
    print(
        "PATTERN INTELLIGENCE ENGINE V2"
    )
    ...
    output = {
        ...
        "engine":
            "EDGE_X_PATTERN_INTELLIGENCE_V2",
